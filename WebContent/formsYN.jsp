...
<head>
   ...
   <div class="content">
    ...
    <div class="input">
            ...
            <input type="radio" name="leiXing" id="check1" value="常见问题"/> 
            <label class="inline">常见问题</label> 
            <input type="radio" name="leiXing" id="check2" value="国外专区"/>
            <label class="inline">国外专区</label> 
            <input type="radio" name="leiXing" id="check3" value="新生专区专区"/>
            <label class="inline">新生专区专区</label> 
            <input type="radio" name="leiXing" id="check4" value="新生专区"/>
   ...
   <!-- *******************************edit********************************************** -->
     ...
     <div class="right">
        <div class="input">
            ...
            <input type="text" name="time" class="datepicker" id="input4"/>
        </div>
    </div> 
    </div> 
        <div class="input">
    ...
    <div class="input">
            ...
            <label for="label">指定推送模块</label>
			<c:choose>
            <c:when test="${news03.leiXing=='常见问题'}">
            <input type="radio" id="check1" name="leiXing" value="常见问题" checked="checked"/> 
            	<label for="check1" class="inline">常见问题</label>	
            	 <input type="radio" id="check2" name="leiXing" value="国外专区" /> 
            	<label for="check2" class="inline">国外专区</label>	
            	<input type="radio" id="check3" name="leiXing" value="新生专区专区" /> 
            	<label for="check3" class="inline">新生专区专区</label>	
            	 <input type="radio" id="check4" name="leiXing" value="新生专区" /> 
            	<label for="check4" class="inline">新生专区</label>	
           </c:when>
           <c:when test="${news03.leiXing=='国外专区'}">
               <input type="radio" id="check1" name="leiXing" value="常见问题" /> 
            	<label for="check1" class="inline">常见问题</label>	
            	 <input type="radio" id="check2" name="leiXing" value="国外专区" checked="checked"/> 
            	<label for="check2" class="inline">国外专区</label>	
            	<input type="radio" id="check3" name="leiXing" value="新生专区专区" /> 
            	<label for="check3" class="inline">新生专区专区</label>	
            	 <input type="radio" id="check4" name="leiXing" value="新生专区" /> 
            ...
            <c:when test="${news03.leiXing=='新生专区专区'}">
             <input type="radio" id="check1" name="leiXing" value="常见问题" /> 
            	<label for="check1" class="inline">常见问题</label>	
            	 <input type="radio" id="check2" name="leiXing" value="国外专区" /> 
            	<label for="check2" class="inline">国外专区</label>	
            	<input type="radio" id="check3" name="leiXing" value="新生专区专区" checked="checked"/> 
            	<label for="check3" class="inline">新生专区专区</label>	
            	 <input type="radio" id="check4" name="leiXing" value="新生专区" /> 
            	<label for="check3" class="inline">新生专区</label>	
            </c:when>
            <c:when test="${news03.leiXing=='新生专区'}">
            <input type="radio" id="check1" name="leiXing" value="常见问题" /> 
            	<label for="check1" class="inline">常见问题</label>	
            	 <input type="radio" id="check2" name="leiXing" value="国外专区" /> 
            	<label for="check2" class="inline">国外专区</label>	
            	<input type="radio" id="check3" name="leiXing" value="新生专区专区" /> 
            	<label for="check3" class="inline">新生专区专区</label>	
            	 <input type="radio" id="check4" name="leiXing" value="新生专区"  checked="checked"/> 
            	<label for="check4" class="inline">新生专区</label>	
            </c:when>
            <c:otherwise>
             <input type="radio" id="check1" name="leiXing" value="常见问题" /> 

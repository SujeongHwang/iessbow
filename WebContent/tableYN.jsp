            ...
            <tbody>
				<c:forEach items="${page.list}" var="p">
					<tr>
						...
						<a href="${ctx }/ynjd/edit?id_YN=${p.id_YN}" title="编辑问题"><img style="border: 1px sold #ccc; padding-left:20px;padding-right:45px;" src="${ctx }/img/icons/actions/edit.png"/></a>
						<a href="${ctx }/ynjd/delete_gg?id_YN=${p.id_YN}" title="删除问题"><img src="${ctx }/img/icons/actions/delete.png"/></a>				
						</td>
					</tr>
				</c:forEach>
                </tbody>
